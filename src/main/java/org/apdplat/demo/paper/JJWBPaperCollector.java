 ...
 * @author 杨尚川
 */
public class JJWBPaperCollector implements PaperCollector{
    private static final Logger LOG = LoggerFactory.getLogger(JJWBPaperCollector.class);
    ...
    public static void main(String[] args) {
        PaperCollector paperCollector = new JJWBPaperCollector();
